# 04 — 04 Care Loop Needs And Actions
...
Implement needs, feed/play/wash/rest/talk/train/heal actions, action reducers, mood, bond, health, offline need decay, capped casual-friendly offline progression, action text, and tests.
