...
Implement optional Supabase schema, migrations, RLS policies, ownership checks, save sync, guest migration, Edge Function reward validation, and local-first conflict resolution.
