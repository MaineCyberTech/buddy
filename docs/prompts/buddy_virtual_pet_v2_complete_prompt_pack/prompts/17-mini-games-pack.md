...
Implement Memory Blink, Food Catch, Shell Shuffle, Rhythm Tap, Tiny Maze, Cloud Hop, Fishing Tap, Cooking Timing game specs with touch/keyboard controls, reward logic, accessibility fallback, tests.
